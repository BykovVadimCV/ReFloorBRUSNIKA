...
class GeometricOpeningDetector:
    ...
    def __init__(self,
                 ...
                 max_opening_thickness_factor: float = 10.0,
                 min_opening_length_factor: float = 0.5,
                 max_opening_length_factor: float = 8.0,
                 max_opening_aspect_ratio: float = 10.0,
                 min_opening_aspect_ratio: float = 4.0,
                 connectivity_tolerance: int = 2,
                 min_gap_width_m: float = 0.30,
                 max_gap_width_m: float = 2.4,
